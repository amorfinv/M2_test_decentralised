...
#         i.neighbors.remove(4481+139) vcommit
# 
...
##00:00:55>QUEUEM2 D83,MP20,151942_MP20,48.157123073,16.4231537829,48.1654460509,16.313703829,0.0,0.0,0.0,3,0,
...
output_file=open(f"151942_MP20.dill", 'wb')
...
# 
#     return qdr, d/nm
# d1=qdrdist(48.2282107,16.3707459,48.2277265,16.3705583)
# d2=qdrdist(48.2277265,16.3705583,48.2264409,16.3700636)
# dif=abs(d2[0]-d1[0])
# if dif>180:
#     dif=360-dif
# print(dif)
